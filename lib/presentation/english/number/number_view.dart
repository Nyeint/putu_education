...
class EnglishNumberView extends StatefulWidget {
  const EnglishNumberView({super.key});

  @override
  State<EnglishNumberView> createState() => _EnglishNumberViewState();
}

class _EnglishNumberViewState extends State<EnglishNumberView> {
                        ...
                        children: List.generate(
                          10,
                              ...
                              child: Container(
                                ...
                                child: Center(child:
                                Text( (((currentPage-1)*10+index)+1).toString(),
