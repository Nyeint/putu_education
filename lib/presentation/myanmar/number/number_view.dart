                            ...
                            children: [
                              Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    border: Border.all(
                                        color: ColorResources.lightBg, width: 2),
                                    ...
                                    children: [
                                      Align(
                                        ...
                                        child: GestureDetector(
                                          onTap: () async => await flutterTts
                                              .speak(selectedNumber.toString()),
                                          child: MyIcon(iconName: 'volume'),
                                        ),
                                      ).pad(right: 16, top: 16),
                                      Text(
                                        selectedNumber.toString().burmese(),
                                        style: FontFamily().semiBold.copyWith(
                                            fontSize: FontSize().sixteenFour),
                                      ),
                                      Text(
                                        numberInWord[selectedNumber - 1],
                                        style: FontFamily().semiBold.copyWith(
                          ...
                          Wrap(
                            ...
                            children: List.generate(
                              ...
                              (index) => GestureDetector(
                                  key: ValueKey(
                                      'number_${(currentPage - 1) * 10 + index + 1}'),
                                  onTap: () async {
                                    setState(() {
                                      selectedNumber =
